---
title: <small>  Analiza przestrzenna dróg rowerowych z podziałem na województwa w 2021 r. </small>
...
<br>
<small>
**Regresja metodą najmniejszych kwadratów** (**OLS**) jest powszechną techniką szacowania współczynników równań regresji liniowej, które opisują związek pomiędzy jedną lub większą liczbą niezależnych zmiennych ilościowych, a zmienną zależną (prosta lub wielokrotna regresja liniowa).Model OLS jest modelem przyczynowo-skutkowym bez interakcji przestrzennych
</small>
]
